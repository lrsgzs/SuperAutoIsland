...
Blockly.Msg['KEYBOARD_NAV_UNCONSTRAINED_MOVE_HINT'] =
    'Hold %1 and use arrow keys to move freely, then %2 to accept the position'; // untranslated
...
Blockly.Msg['MATH_CONSTANT_TOOLTIP'] =
    '返回一个以下常见常数：π (3.141…)、e (2.718…)、φ (1.618…)、根号2 (1.414…)、根号½ (0.707…)或∞ (无穷)。';
...
Blockly.Msg['MATH_IS_TOOLTIP'] =
    '检查一个数是否是偶数、奇数、质数、整数、正数、负数，或者是否能被某数整除。返回真或假。';
